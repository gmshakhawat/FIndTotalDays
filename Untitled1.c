...
char *month[13] = {"None", "Jan", "Feb", "Mar","Apr", "May", "June", "July","Aug", "Sept", "Oct","Nov", "Dec"};

/*
daysPerMonth[0] = non leap year
daysPerMonth[1] = leap year
*/
int daysPerMonth[2][13] = {{-1, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31},{-1, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}};
...
int main(void)
{
    ...
    while(1){
         printf("Enter Start : (day month year Ex: 8 10 2016 )\n");
         scanf("%d %d %d",&dd1,&mm1,&yy1);

         printf("Enter End : (day month year Ex: 8 10 2017 )\n");
